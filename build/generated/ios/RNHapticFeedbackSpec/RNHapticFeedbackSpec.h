...
namespace JS {
  namespace NativeHapticFeedback {
    struct SpecTriggerPatternOptions {
      std::optional<bool> enableVibrateFallback() const;
      std::optional<bool> ignoreAndroidSystemSettings() const;

      SpecTriggerPatternOptions(NSDictionary *const v) : _v(v) {}
    private:
      NSDictionary *_v;
    };
  }
...
@interface RCTCxxConvert (NativeHapticFeedback_SpecTriggerPatternOptions)
...
- (void)triggerPattern:(NSArray *)events
               options:(JS::NativeHapticFeedback::SpecTriggerPatternOptions &)options;
- (void)playAHAP:(NSString *)fileName
         resolve:(RCTPromiseResolveBlock)resolve
          reject:(RCTPromiseRejectBlock)reject;
- (void)getSystemHapticStatus:(RCTPromiseResolveBlock)resolve
                       reject:(RCTPromiseRejectBlock)reject;
...
inline std::optional<bool> JS::NativeHapticFeedback::SpecTriggerPatternOptions::enableVibrateFallback() const
{
  id const p = _v[@"enableVibrateFallback"];
  return RCTBridgingToOptionalBool(p);
}
inline std::optional<bool> JS::NativeHapticFeedback::SpecTriggerPatternOptions::ignoreAndroidSystemSettings() const
{
  id const p = _v[@"ignoreAndroidSystemSettings"];
  return RCTBridgingToOptionalBool(p);
}
